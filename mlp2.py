...
for idx, features in enumerate([features_1, features_2, features_3, features_4, features_5]):
    features['label'] = idx
...
plt.title(f'Confusionsmatrix Dino unbalanced Dataset Mlp: Test accuracy: {accuracy}')
plt.show()
